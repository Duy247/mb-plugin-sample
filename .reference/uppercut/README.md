...
<!-- Plugin description -->
This *100% free* IntelliJ plugin provides test execution support for Karate language files.

Features include 
- Running tests from IntelliJ
- Run configurations for Karate tests
- Test execution with custom settings (environment, parallelism, tags)
- Console output parsing and test results display
